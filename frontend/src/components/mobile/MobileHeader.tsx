    ...
    <header className="sticky top-0 z-40 bg-slate-800 border-b border-slate-700 shadow-sm">
      <div className="h-14 px-4 flex items-center justify-between gap-3">
        ...
        {showMenu && onMenuClick && (
          <button
            onClick={onMenuClick}
            className="w-11 h-11 flex items-center justify-center rounded-lg hover:bg-slate-900 active:bg-slate-200 transition-colors"
            aria-label="Menu"
        ...
        <div className="flex items-center gap-2">
          ...
          {showNotifications && onNotificationClick && (
            <button
              ...
              className="relative w-11 h-11 flex items-center justify-center rounded-lg hover:bg-slate-900 active:bg-slate-200 transition-colors"

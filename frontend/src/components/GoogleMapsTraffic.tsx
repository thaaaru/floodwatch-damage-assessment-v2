...
export default function GoogleMapsTraffic() {
  ...
  return (
    <div className="relative h-full w-full">
      ...
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center bg-slate-900 rounded-lg z-10">
          <div className="text-center">
            ...
            <p className="mt-4 text-slate-300">Loading Google Maps Traffic...</p>
          </div>
        </div>
      )}
      ...
      {/* Traffic Legend */}
      {!isLoading && (
        <div className="absolute bottom-6 left-4 bg-slate-800/95 backdrop-blur-sm rounded-lg shadow-lg p-3 z-10">
          ...
          <div className="space-y-1.5 text-xs">
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-300">Fast / Normal flow</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-8 h-2 rounded" style={{ backgroundColor: '#f5a623' }}></div>
              <span className="text-slate-300">Slow moving</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-8 h-2 rounded" style={{ backgroundColor: '#e34133' }}></div>
              <span className="text-slate-300">Heavy / Congested</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-8 h-2 rounded" style={{ backgroundColor: '#811f1f' }}></div>
              <span className="text-slate-300">Very slow / Blocked</span>
            </div>
          </div>

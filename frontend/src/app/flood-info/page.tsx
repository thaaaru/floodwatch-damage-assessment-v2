      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-8 py-4 sm:py-6 lg:py-8">
        {loading ? (
          ...
          <div className="space-y-6">
            ...
            {floodThreat && (
              <div className={`glass rounded-2xl p-6 border-2 shadow-lg ${getThreatLevelBorder(floodThreat.national_threat_level)}`}>
            ...
            {riverStations.length > 0 && (
              <div className="glass rounded-2xl p-3 sm:p-4 shadow-lg">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-3 sm:mb-4">
                  <h2 className="text-base sm:text-lg font-semibold flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2">
                    ...
                    <span className="text-xs sm:text-sm font-normal text-gray-400">({riverStations.length} stations monitored)</span>
                  </h2>
                  <a
                    ...
                    <table className="w-full text-xs sm:text-sm min-w-[640px]">
                      <thead>
                        <tr className="text-gray-400 border-b border-gray-700 text-[10px] sm:text-xs">
                          ...
                          <th className="text-center py-2 px-1 text-orange-400 cursor-help" title="Stations with rising water levels">Rising</th>
                          <th className="text-center py-2 px-1 text-yellow-400 cursor-help" title="Stations in alert status">Alert</th>
                          <th className="text-center py-2 px-1 text-blue-400 cursor-help" title="Stations with falling water levels">Falling</th>
                          <th className="text-center py-2 px-1 text-green-400 cursor-help" title="Stations at normal water levels">Normal</th>
                            ...
                            .map((row, idx) => (
                              <tr key={idx} className="border-b border-gray-700 hover:bg-white/10 group/row relative transition-colors">
                                <td className="py-2 px-1 sm:px-2 font-medium cursor-help relative">
                                  ...
                                  <div className="absolute left-0 top-full mt-1 px-3 py-2 bg-gray-900 text-xs text-gray-200 rounded-lg opacity-0 group-hover/row:opacity-100 transition-opacity pointer-events-none w-80 z-20 shadow-lg border border-gray-700">

              ...
              {floodPatterns ? (
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                    <div className="bg-slate-800 border border-blue-400/30 rounded-xl p-4 text-center shadow-md">
                      <div className="text-3xl font-bold text-blue-400">{fmt(floodPatterns.summary.avg_annual_rainfall_mm)}</div>
                      <div className="text-xs text-slate-400 mt-1">Avg Annual Rainfall (mm)</div>
                    </div>
                    <div className="bg-slate-800 border border-orange-400/30 rounded-xl p-4 text-center shadow-md">
                      <div className="text-3xl font-bold text-orange-400">{fmt(floodPatterns.summary.max_daily_rainfall_mm)}</div>
                      <div className="text-xs text-slate-400 mt-1">Max Daily Rainfall (mm)</div>
                    </div>
                    <div className="bg-slate-800 border border-cyan-400/30 rounded-xl p-4 text-center shadow-md">
                      <div className="text-3xl font-bold text-cyan-400">{floodPatterns.summary.heavy_rain_days}</div>
                      <div className="text-xs text-slate-400 mt-1">Heavy Rain Days (&gt;50mm)</div>
                    </div>
                    <div className="bg-slate-800 border border-red-400/30 rounded-xl p-4 text-center shadow-md">
                      <div className="text-3xl font-bold text-red-400">{floodPatterns.summary.extreme_rain_days}</div>
                      <div className="text-xs text-slate-400 mt-1">Extreme Days (&gt;100mm)</div>
                    </div>
                  </div>

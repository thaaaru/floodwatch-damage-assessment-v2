...
function ImageComparisonSlider({
  ...
  return (
    <div
      className="relative w-full h-[400px] overflow-hidden rounded-xl cursor-ew-resize select-none bg-slate-900"
    ...
    >
      ...
      {/* Slider handle */}
      <div
        className="absolute top-0 bottom-0 w-1 bg-slate-800 shadow-lg cursor-ew-resize z-10"
        style={{ left: `${sliderPosition}%`, transform: 'translateX(-50%)' }}
      >
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-10 h-10 bg-slate-800 rounded-full shadow-lg flex items-center justify-center">
...
export default function DamageGalleryPage() {
  ...
  const getSeverityColor = (severity: string) => {
    switch (severity) {
      case 'high': return 'bg-red-100 text-red-300 border-red-700/50';
      case 'medium': return 'bg-orange-100 text-orange-300 border-orange-700/50';
      case 'low': return 'bg-yellow-100 text-yellow-300 border-yellow-700/50';
  ...
  return (
    <div className="min-h-screen bg-slate-900">
        ...
        <div className="max-w-7xl mx-auto px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-lg font-bold text-white">Disaster Damage Gallery</h1>
                <p className="text-xs text-slate-400">Before & After Satellite Imagery Comparison</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              ...
              <a href="/damage-map" className="px-3 py-2 rounded-lg bg-slate-900 hover:bg-blue-200 text-blue-300 text-sm font-medium transition-colors">
                Detection Map
              </a>
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        {showSatelliteViewer && (
          <div className="mb-6 bg-slate-800 rounded-xl border border-slate-700 shadow-sm overflow-hidden">
            <div className="p-4 border-b border-slate-700 bg-slate-900 flex items-center justify-between">
              <div>
                <h3 className="font-semibold text-white">Live Satellite Viewer</h3>
                <p className="text-sm text-slate-400">Explore real-time satellite imagery from multiple sources</p>
              </div>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-4">
              <a
                ...
                className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-700/50 hover:shadow-md transition-shadow"
              >
                <div className="w-14 h-14 rounded-xl bg-blue-500 flex items-center justify-center">
                  <span className="text-2xl">🌍</span>
                </div>
                <div>
                  <div className="font-semibold text-white">Zoom Earth</div>
                  <div className="text-sm text-slate-300">Real-time weather & satellite</div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-700/50 hover:shadow-md transition-shadow"
              >
                <div className="w-14 h-14 rounded-xl bg-emerald-500 flex items-center justify-center">
                  <span className="text-2xl">🛰️</span>
                </div>
                <div>
                  <div className="font-semibold text-white">Sentinel Hub EO Browser</div>
                  <div className="text-sm text-slate-300">Sentinel-1 & Sentinel-2 imagery</div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-br from-purple-50 to-indigo-50 border border-purple-700/50 hover:shadow-md transition-shadow"
              >
                <div className="w-14 h-14 rounded-xl bg-purple-500 flex items-center justify-center">
                  <span className="text-2xl">🚀</span>
                </div>
                <div>
                  <div className="font-semibold text-white">NASA Worldview</div>
                  <div className="text-sm text-slate-300">MODIS & VIIRS daily imagery</div>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-4 p-4 rounded-xl bg-gradient-to-br from-orange-50 to-amber-50 border border-orange-700/50 hover:shadow-md transition-shadow"
              >
                <div className="w-14 h-14 rounded-xl bg-orange-500 flex items-center justify-center">
                  <span className="text-2xl">📡</span>
                </div>
                <div>
                  <div className="font-semibold text-white">Maxar Open Data</div>
                  <div className="text-sm text-slate-300">High-res disaster imagery</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-800 rounded-xl p-4 border border-slate-700 shadow-sm">
              <h3 className="text-sm font-semibold text-white mb-3">Filter Events</h3>
                  ...
                  <button
                    ...
                    className={`flex-1 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                      filterType === filter.id
                        ? 'bg-slate-900 text-blue-300 border border-blue-700/50'
                        : 'bg-slate-900 text-slate-300 border border-slate-700 hover:bg-slate-900'
                    }`}
                  >
            ...
            <div className="bg-slate-800 rounded-xl border border-slate-700 shadow-sm overflow-hidden">
              <div className="p-3 border-b border-slate-700 bg-slate-900">
                <h3 className="text-sm font-semibold text-white">Recent Disaster Events</h3>
                <p className="text-xs text-slate-400">{filteredEvents.length} events with satellite imagery</p>
              </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="text-xs text-slate-400">{event.district} • {event.date}</div>
          ...
          <div className="lg:col-span-2 space-y-4">
            ...
            <div className="bg-slate-800 rounded-xl p-4 border border-slate-700 shadow-sm">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-300 mt-1">{selectedEvent.location}, {selectedEvent.district}</p>
                </div>
                <div className="text-right">
                  ...
                  <div className="text-sm text-slate-400 mt-1">{selectedEvent.date}</div>
                </div>
              </div>
            </div>
                ...
                <div className="mt-4 pt-4 border-t border-slate-100">
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-medium text-white">{selectedEvent.casualties}</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Quick Actions */}
            <div className="bg-slate-800 rounded-xl p-4 border border-slate-700 shadow-sm">
              <h3 className="text-sm font-semibold text-white mb-3">Explore Imagery</h3>
              <div className="grid grid-cols-4 gap-2">
                <a
                  href={`https://apps.sentinel-hub.com/eo-browser/?zoom=12&lat=${selectedEvent.coordinates.lat}&lng=${selectedEvent.coordinates.lon}&themeId=DEFAULT-THEME&datasetId=S2L2A&layerId=1_TRUE_COLOR`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 p-3 rounded-lg bg-emerald-600/20 hover:bg-emerald-100 border border-emerald-700/50 transition-colors"
                >
                  <span className="text-2xl">🛰️</span>
                  <span className="text-xs font-medium text-emerald-300">Sentinel-2</span>
                </a>
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 p-3 rounded-lg bg-orange-600/20 hover:bg-orange-100 border border-orange-700/50 transition-colors"
                >
                  <span className="text-2xl">📡</span>
                  <span className="text-xs font-medium text-orange-300">Sentinel-1 SAR</span>
                </a>
                <a
                  href={`https://zoom.earth/#view=${selectedEvent.coordinates.lat},${selectedEvent.coordinates.lon},12z`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 p-3 rounded-lg bg-blue-600/20 hover:bg-slate-900 border border-blue-700/50 transition-colors"
                >
                  <span className="text-2xl">🌍</span>
                  <span className="text-xs font-medium text-blue-300">Zoom Earth</span>
                </a>
                <a
                  href={`https://www.google.com/maps/@${selectedEvent.coordinates.lat},${selectedEvent.coordinates.lon},14z/data=!3m1!1e3`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex flex-col items-center gap-2 p-3 rounded-lg bg-slate-900 hover:bg-slate-900 border border-slate-700 transition-colors"
                >
                  <span className="text-2xl">🗺️</span>
                  <span className="text-xs font-medium text-slate-200">Google Maps</span>
                </a>
              </div>
            </div>
          </div>
